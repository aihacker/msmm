...
public class EditShareCommentActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_confirm:
                SPUtils.getInstance().put("share_comment", mTvContent.getText().toString());
    ...
    private void showPreDialog() {
        ...
        View view = LayoutInflater.from(EditShareCommentActivity.this).inflate(R.layout.dialog_pre_share, null);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EditShareCommentActivity.this).setView(view);
