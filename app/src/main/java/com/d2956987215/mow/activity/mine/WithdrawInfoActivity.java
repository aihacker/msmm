...
public class WithdrawInfoActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void indata() {
        ...
        map.put("type", "2");
        map.put("page", p + "");
        new Request<AccuntListResponse>().request(RxJavaUtil.xApi().settleMent(map, "Bearer " + User.token()), "浏览商品", this, false, new Result<AccuntListResponse>() {
            @Override
...
//                        statusLayoutManager.showEmptyLayout();
            ...
            @Override
            public void onBackErrorMessage(AccuntListResponse response) {
