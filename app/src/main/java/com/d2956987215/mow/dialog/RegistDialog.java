...
public class RegistDialog extends BaseDialog implements View.OnClickListener {
    private Activity activity;
    private TextView tv_quxiao, tv_queding;

    CallBack callback;

    public RegistDialog(Context context, CallBack callBack) {
        super(context);
    ...
    private void init() {
        setContentView(R.layout.ml_dialog_regist);
