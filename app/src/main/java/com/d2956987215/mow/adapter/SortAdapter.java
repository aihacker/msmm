...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
	private List<AreaBean.DataBean> list = null;
	private Context mContext;
	
	public SortAdapter(Context mContext, List<AreaBean.DataBean> list) {
	 ...
	 * @param list
	 */
	public void updateListView(List<AreaBean.DataBean> list){
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final AreaBean.DataBean mContent = list.get(position);
		if (view == null) {
			...
			viewHolder.tv_tip = view.findViewById(R.id.tv_tip);
		...
		String s = "+" + this.list.get(position).getAreaCode();
		viewHolder.tv_tip.setText(s);
		return view;
