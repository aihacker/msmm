...
public class HomeHotAdapter extends BaseQuickAdapter<HomeListResponse.DataBeanX.DataBean, BaseViewHolder> {
    private List<HomeListResponse.DataBeanX.DataBean> data;

    public HomeHotAdapter(@LayoutRes int layoutResId, @Nullable List<HomeListResponse.DataBeanX.DataBean> data) {
    ...
    public void notifyData(List<HomeListResponse.DataBeanX.DataBean> mData) {
        data.clear();
        data.addAll(mData);
    ...
    @Override
    protected void convert(BaseViewHolder holder, final HomeListResponse.DataBeanX.DataBean item) {
