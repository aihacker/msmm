...
public class ConditionOneAdapter extends BaseQuickAdapter<MemberUpgradeResponse.DataBean.ConditionOneBean, BaseViewHolder> {

    private Activity mActivity;
    private int roletype;

    public ConditionOneAdapter(int layoutResId, @Nullable List<MemberUpgradeResponse.DataBean.ConditionOneBean> data, int roletype, Activity mActivity) {
    ...
    @Override
    protected void convert(final BaseViewHolder baseViewHolder, final MemberUpgradeResponse.DataBean.ConditionOneBean dataBean) {
