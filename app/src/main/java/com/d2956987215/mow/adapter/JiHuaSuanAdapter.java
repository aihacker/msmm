...
public class JiHuaSuanAdapter extends BaseQuickAdapter<JuHuaSuanResponse.DataBean.GoodsListBean, BaseViewHolder> {
    public JiHuaSuanAdapter(@LayoutRes int layoutResId, @Nullable List<JuHuaSuanResponse.DataBean.GoodsListBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder holder, final JuHuaSuanResponse.DataBean.GoodsListBean item) {
