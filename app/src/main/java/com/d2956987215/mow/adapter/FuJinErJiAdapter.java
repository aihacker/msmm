...
public class FuJinErJiAdapter extends BaseQuickAdapter<LunTanTitleResponse.DataBean, BaseViewHolder> {
    ...
    public FuJinErJiAdapter(@LayoutRes int layoutResId, @Nullable List<LunTanTitleResponse.DataBean> data) {
